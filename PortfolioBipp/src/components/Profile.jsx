      ...
      <div className="indentity">
        ...
        <div>
         ...
         <h1>NICKNAME : BIPP</h1>
          ...
          <img src="/Pic/iconfacebook.png" alt="MyFacebook" className="myIcon" />

          <img src="/Pic/iconlinkedin.png" alt="Mylinkedin" className="myIcon" />

          <img src="/Pic/icongithub.png" alt="MyGithub" className="myIcon" />

          <div><img src="/Pic/Qr.jpg" alt="MyQr" className="qrSize" /></div>
